...
public class LayoutTests
{
    ...
    {
        // Arrange
        var stack = new StackLayout { PaddingValue = 10 };
        
        // Act
        var size = stack.Measure(Size.Empty, _context);
        
        // Assert - 空 Stack 只有 Padding
    ...
    public void StackLayout_Measure_ShouldReturnCorrectSize_ForVerticalStack()
    {
        ...
        var label1 = new Label { Text = "Hello", FontSizeValue = 14 };
        var label2 = new Label { Text = "World", FontSizeValue = 14 };
        ...
        // Assert
        // 每个 Label 高度约 14 * 1.3 = 18.2
        // 总高度 = 18.2 + 18.2 + 10 (spacing) + 10 (padding * 2)
    ...
    public void StackLayout_Measure_ShouldReturnCorrectSize_ForHorizontalStack()
    {
        ...
        // 总宽度 = 42 + 42 + 10 (spacing) + 10 (padding * 2)
    ...
    {
        // Arrange
        var label = new Label { Text = "Hello", FontSizeValue = 16 };
    ...
    {
        // Arrange
        var label14 = new Label { Text = "Test", FontSizeValue = 14 };
        var label28 = new Label { Text = "Test", FontSizeValue = 28 };
        ...
        // Assert - 字体大小翻倍，尺寸也翻倍
        Assert.Equal(size28.Width, size14.Width * 2, 1);
    ...
    {
        // Arrange
        var button = new Button { Text = "Click", FontSizeValue = 14 };
