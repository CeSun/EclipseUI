...
public readonly struct Color : IEquatable<Color>
{
    ...
    public static Color FromArgb(int alpha, Color baseColor) 
        => new(baseColor.R, baseColor.G, baseColor.B, (byte)alpha);
    ...
    /// <summary>
    /// 从 RGB/RGBA 字符串解析颜色
    /// 格式: rgb(255,0,0) 或 rgba(255,0,0,0.5)
    /// </summary>
    public static Color FromRgbString(string rgbColor)
    {
        ...
        {
            var a = (byte)(double.Parse(match.Groups[4].Value) * 255);
            return new Color(r, g, b, a);
        }
